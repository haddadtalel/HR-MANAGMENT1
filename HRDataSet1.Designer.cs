...
namespace HR_MANAGMENT1._2.HRDataSet1TableAdapters {
    ...
    public partial class JobsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Jobs] WHERE (([Job_id] = @Original_Job_id) AND ((@IsNull_Job_t" +
                "itle = 1 AND [Job_title] IS NULL) OR ([Job_title] = @Original_Job_title)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Jobs] SET [Job_id] = @Job_id, [Job_title] = @Job_title WHERE (([Job_id] = @Original_Job_id) AND ((@IsNull_Job_title = 1 AND [Job_title] IS NULL) OR ([Job_title] = @Original_Job_title)));
SELECT Job_id, Job_title FROM Jobs WHERE (Job_id = @Job_id)";
        ...
        public virtual int Fill(HRDataSet1.JobsDataTable dataTable) {
        ...
        public virtual HRDataSet1.JobsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HRDataSet1.JobsDataTable dataTable = new HRDataSet1.JobsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HRDataSet1.JobsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Job_id, string Original_Job_title) {
        ...
        public virtual int Update(string Job_id, string Job_title, string Original_Job_id, string Original_Job_title) {
            if ((Job_id == null)) {
                throw new global::System.ArgumentNullException("Job_id");
            }
            else {
            ...
            if ((Original_Job_id == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_Job_id));
            }
            if ((Original_Job_title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Job_title, string Original_Job_id, string Original_Job_title) {
